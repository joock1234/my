 ...
 */
public class DailyGetYBAccountFileImpl extends BaseTaskJobDetail {
    ...
    private void DailyGetAccountFile(TaskInfoDTO taskInfo) throws InterruptedException {
    	 logger.warn("=================================Daily Switch YB start:========================");
    	String channlBankId = CorgeEnum.YB_B2C.getValue();
    	ChannelMsg msg = new ChannelMsg();
    	msg.setChannelBank("YB");
    	...
    	if(result.isSuccess()){
    		logger.info("=================DailyGetYBAccountFile FileDown success!");
    	}else{
    		logger.info("=================DailyGetYBAccountFile FileDown fail!");
    	}
        logger.warn("=================================Daily Switch YB end:========================");
    }
