 ...
 */
public class DailyGetJKBWeiXinAccountFileImpl extends BaseTaskJobDetail {
    ...
    private void DailyGetAccountFile(TaskInfoDTO taskInfo) throws InterruptedException {
    	logger.warn("=================================Daily Switch JKB start:========================");
    	String channlBankId = CorgeEnum.WX_JKB_INNERPAY_JSAPI.getValue();
    	ChannelMsg msg = new ChannelMsg();
    	msg.setChannelBank("JKB");
    	...
    	if(result.isSuccess()){
    		logger.info("=================DailyGetJKBAccountFile FileDown success!");
    	}else{
    		logger.info("=================DailyGetJKBAccountFile FileDown fail!");
    	}
        logger.warn("=================================Daily Switch JKB end:========================");
    }
