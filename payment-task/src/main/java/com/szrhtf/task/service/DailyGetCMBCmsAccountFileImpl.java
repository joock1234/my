 ...
 */
public class DailyGetCMBCmsAccountFileImpl extends BaseTaskJobDetail {
    ...
    private void DailyGetAccountFile(TaskInfoDTO taskInfo) throws InterruptedException {
    	logger.warn("=================================Daily Switch MS start:========================");
    	String channlBankId = CorgeEnum.MS_NOCARD.getValue();
    	ChannelMsg msg = new ChannelMsg();
    	msg.setChannelBank("MS");
    	...
    	if(result.isSuccess()){
    		logger.info("=================DailyGetMSAccountFile FileDown success!");
    	}else{
    		logger.info("=================DailyGetMSAccountFile FileDown fail!");
    	}
        logger.warn("=================================Daily Switch MS end:========================");
    }
}
