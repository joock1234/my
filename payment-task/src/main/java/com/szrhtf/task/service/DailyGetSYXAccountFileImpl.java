 ...
 */
public class DailyGetSYXAccountFileImpl extends BaseTaskJobDetail {
    ...
    private void DailyGetAccountFile(TaskInfoDTO taskInfo) throws InterruptedException {
    	logger.warn("=================================Daily Switch SYX start:========================");
    	String channlBankId = CorgeEnum.SYX_B2C.getValue();
    	ChannelMsg msg = new ChannelMsg();
    	msg.setChannelBank("SYX");
    	...
    	if(result.isSuccess()){
    		logger.info("=================DailyGetSYXAccountFile FileDown success!");
    	}else{
    		logger.info("=================DailyGetSYXAccountFile FileDown fail!");
    	}
        logger.warn("=================================Daily Switch SYX end:========================");
    }
